                    ...
                    <div className="absolute inset-0 bg-white rounded-2xl flex justify-center items-center flex-row z-20">
                        <div className="flex flex-col items-center gap-4 sm:gap-10 ">
                            <div className='flex flex-col items-center gap-5'>
                                ...
                                <h5 className="text-xl sm:text-3xl text-center font-medium text-gray-900">Dr. Juan Carlos Benavides Solarte</h5>
                                <span className="text-xl sm:text-2xl font-medium text-gray-500 dark:text-gray-400 ">Cirujano Dentista</span>
                            ...
                            <div className='flex flex-col items-center  gap-1'>
                                ...
                                <span className="text-sm sm:text-xl  text-gray-500 dark:text-gray-400 mb-10">Ortodoncia y Ortopedia Bucomaxilofacial</span>
                    ...
                    <div className='absolute inset-0 rounded-2xl flex flex-col justify-center items-center z-20 gap-2 sm:gap-10 mx-2 sm:mx-12 '>
                        <div className='flex flex-col items-center gap-4 sm:gap-10'>
                            <div className="flex flex-col gap-1">
                                <h3 className="font-bold text-white text-foreground/90 text-lg sm:text-2xl">Dr. Juan Carlos Benavides Solarte</h3>
                        ...
                        <div className="flex flex-col items-center  gap-2">
                            ...
                            <div className="flex flex-col justify-between list-disc gap-1 sm:gap-4">
                                <li className=" text-xs sm:text-sm font-light">Cirujano Dentista en el área privada con más de 12 años de experiencia</li>
                                <li className=" text-xs sm:text-sm font-light">Especialidad de Ortodoncia y O.M.B, Universidad Católica de Uruguay</li>
                                <li className=" text-xs sm:text-sm font-light">Maestría en Anclaje Esqueletal Instituto Mondelli de Ortodoncia, Brasil</li>
                                <li className=" text-xs sm:text-sm font-light">Residencia en Microtornillos Extraalveolares</li>
                                <li className=" text-xs sm:text-sm font-light">Certificación en Invisaling</li>
                                <li className=" text-xs sm:text-sm font-light">actualización en ortodoncia y vías aéreas Universidad de New York</li>
                            </div>
                        </div>
