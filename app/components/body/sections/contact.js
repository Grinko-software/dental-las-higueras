...
export default function Contact () {
    return (
        <section id='Contacto' className="flex flex-1 flex-col min-h-[50rem] items items-center justify-center bg-[url('https://www.clinicatrei.com/wp-content/uploads/2022/10/dientes-desgastados.jpg')]">
